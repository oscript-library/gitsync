...
[![GitHub release](https://img.shields.io/github/release/khorevaa/gitsync3.svg)](https://github.com/oscript-library/gitsync3/releases)
...
- [Использование приложения `gitsync3`](#использование-приложения-gitsync3)
...
<a id="markdown-использование-приложения-gitsync3" name="использование-приложения-gitsync3"></a>
## Использование приложения `gitsync3`
...
<a id="markdown-использование-библиотеки-gitsync3" name="использование-библиотеки-gitsync3"></a>
## Использование библиотеки `gitsync3`
...
1. Доработка предустановленных плагинов производиться в отдельном репозитории [gitsync3-pre-plugins](https://github.com/khorevaa/gitsync3-pre-plugins)


<a id="markdown-механизм-подписок-на-события" name="механизм-подписок-на-события"></a>
## Механизм подписок на события 

Проект `gitsync3` поддерживает ряд подписок на события
