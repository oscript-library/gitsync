...
Процедура Тест_ДолженПроверитьЧтоВызванОбработчикСинхронизации() Экспорт
	...
	юТест.ПроверитьНеравенство(Неопределено, мПараметрыВызоваПакетногоСинхронизатора);
	юТест.ПроверитьРавенство("test", мПараметрыВызоваПакетногоСинхронизатора.Имя);
