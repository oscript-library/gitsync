...
Контекст: Тестовый контекст синхронизации
    ...
    И Я включаю отладку лога с именем "oscript.app.gitsync3.plugins.loader"
    И Я включаю отладку лога с именем "oscript.app.gitsync3.plugins.event-subscriptions"
