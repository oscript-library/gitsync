...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ЯСоздаюТестовыйФайлAuthors");
	...
	ВсеШаги.Добавить("ЯСоздаюНеполныйТестовыйФайлAuthors");
	ВсеШаги.Добавить("ЯСоздаюНовыйОбъектГитрепозиторий");
	ВсеШаги.Добавить("ЯУстанавливаюАвтораВРепозитории");
...
//Я устанавливаю автора в репозитории
Процедура ЯУстанавливаюАвтораВРепозитории() Экспорт
	ГитРепозиторий = БДД.ПолучитьИзКонтекста("ГитРепозиторий");
	
	ГитРепозиторий.УстановитьНастройку("user.email", "you@example.com", РежимУстановкиНастроекGit.Глобально);
	ГитРепозиторий.УстановитьНастройку("user.name", "Your Name", РежимУстановкиНастроекGit.Глобально);
КонецПроцедуры
...
//Я создаю тестовый файл AUTHORS
Процедура ЯСоздаюТестовыйФайлAuthors() Экспорт
...
Процедура ЯУстанавливаюПутьВыполненияКомандыКТекущейБиблиотеке(Знач ИмяКоманды) Экспорт
	...
	ПутьГитсинк = ПолучитьПеременнуюСреды("GITSYNC_TESTING_PATH");
...
//Я создаю неполный тестовый файл AUTHORS
Процедура ЯСоздаюНеполныйТестовыйФайлAuthors() Экспорт
