...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ЯИщуПлатформуИСохраняюНайденныйПуть");
...
//Я ищу платформу и сохраняю найденный путь "ПутьКПлатформе1С"
Процедура ЯИщуПлатформуИСохраняюНайденныйПуть(Знач ИмяПеременной) Экспорт
