...
Функционал: Работа плагина инекрементальной выгрузки конфигурации
    Как Пользователь
...
Контекст: Тестовый контекст
    ...
    И я включаю отладку лога с именем "oscript.app.gitsync.plugins.increment"
...
Сценарий: Cинхронизация с использованием increment
    Допустим Я добавляю параметр "-plugins increment" для команды "gitsync" 
