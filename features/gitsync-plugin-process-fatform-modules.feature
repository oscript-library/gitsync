...
Контекст: Тестовый контекст
    ...
    И я включаю отладку лога с именем "oscript.app.gitsync.plugins.process-fatform-modules"
...
Сценарий: Cинхронизация с использованием process-fatform-modules
    Допустим Я добавляю параметр "-plugins process-fatform-modules" для команды "gitsync" 
