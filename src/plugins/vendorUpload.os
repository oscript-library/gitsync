...
Процедура ПриРегистрацииКомандыПриложения(ИмяКоманды, КлассРеализации, Парсер) Экспорт
	...
	КлассРеализации.Опция("H vendorHistory", Ложь, "[*vendorUpload] флаг получения истории версий используя отчет по версиям").Флаг();
	КлассРеализации.Опция("u storage-user", "", "[*vendorUpload] <пользователь хранилища конфигурации>").ТСтрока();
	КлассРеализации.Опция("p storage-pwd", "", "[*vendorUpload] <пароль пользователя хранилища конфигурации>").ТСтрока();
