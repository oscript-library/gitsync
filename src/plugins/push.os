...
Процедура ПриРегистрацииКомандыПриложения(ИмяКоманды, КлассРеализации, Парсер) Экспорт
	...
	КоличествоКоммитовДоPushКласс = КлассРеализации.Опция("n push-every-n-commits", 0, "[*push] <число> количество коммитов до промежуточной отправки на удаленный сервер").ТЧисло();
	ОтправлятьТегиКласс = КлассРеализации.Опция("t push-tags", Ложь, "[*push] Флаг отправки установленных меток").Флаг();
