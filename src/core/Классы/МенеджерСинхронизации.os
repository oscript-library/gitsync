...
Функция АвторизацияВХранилищеКонфигурации(Знач Пользователь, Знач Пароль) Экспорт
	...
	АвторизацияВХранилище.Вставить("Пользователь" , Пользователь);
	АвторизацияВХранилище.Вставить("Пароль", Пароль);
...
Функция ПолучитьХранилищеКонфигурации(Знач ПутьКХранилищу)
	...
	МенеджерХранилищаКонфигурации.УстановитьПараметрыАвторизации(АвторизацияВХранилище.Пользователь, АвторизацияВХранилище.Пароль);
