...
Процедура ЗагрузитьПлагины() Экспорт
	...
	ЕстьОшибкаЗагрузкиПлагинов = ТекущийЗагрузчикПлагинов.ЕстьОшибкаЗагрузкиПлагинов;
...
Процедура ВключитьПлагин(Знач ИмяПлагина) Экспорт
	...
	Если Плагин = Неопределено Тогда
		...
		Если ЕстьОшибкаЗагрузкиПлагинов Тогда
			
			ТекстСообщенияПользователю = СтрШаблон(
				"Не удалось включить плагин <%1>. Необходимо переустановить плагины.",
				ИмяПлагина
			);
