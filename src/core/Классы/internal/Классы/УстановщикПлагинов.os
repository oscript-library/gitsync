...
Функция ПредставлениеЗависимостей(Зависимости)
	...
	Для Каждого КлючЗначение Из Зависимости Цикл
		Результат = Результат + ПредставлениеОднойЗависимости(КлючЗначение.Ключ, КлючЗначение.Значение) + " ";
	КонецЦикла;
...
Функция ПредставлениеОднойЗависимости(Знач ИмяПакета, Знач Версия = Неопределено)

	Если ЗначениеЗаполнено(Версия) Тогда
		Возврат СтрШаблон("%1@%2", ИмяПакета, Версия);
	КонецЕсли;
