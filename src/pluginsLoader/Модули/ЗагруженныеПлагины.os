...
Процедура ЗагрузитьПлагины(Знач КаталогПлагинов) Экспорт

	ЗагрузчикПлагинов = Новый ЗагрузчикПлагинов;
	ЗагрузчикПлагинов.ЗагрузитьПлагины(КаталогПлагинов)
	
КонецПроцедуры

МассивПлагинов = Новый Массив;
КаталогПлагиновПоУмолчанию = ОбъединитьПути(ТекущийСценарий().Каталог, "..", "..", "plugins");
ЗагрузитьПлагины(КаталогПлагиновПоУмолчанию);