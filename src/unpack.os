...
Перем ЭтоWindows;
Перем ОписаниеИерархическогоФормата;
...
Процедура ВыгрузитьМодулиКонфигурации(Знач ФайлКонфигурации, Знач КаталогПлоскойВыгрузки, Знач Формат) Экспорт
	...
	Если Формат = ОписаниеИерархическогоФормата Тогда
		ПараметрыЗапуска.Добавить("/DumpConfigToFiles """ + КаталогПлоскойВыгрузки + """");
	Иначе
		ПараметрыЗапуска.Добавить("/DumpConfigToFiles """ + КаталогПлоскойВыгрузки + """ -format Plain");
	КонецЕсли;
...
Процедура РазложитьМодули1СПоПапкамСогласноИерархииМетаданных(Знач КаталогПлоскойВыгрузки, Знач КаталогИерархическойВыгрузки, Знач Формат) Экспорт
	...
	ИскатьВПодкаталогах = ?(Формат = ОписаниеИерархическогоФормата, Истина, Ложь);
	...
	Для Каждого Файл Из СписокФайлов Цикл
		...
		Если Нрег(Прав(Файл.ПолноеИмя, 5)) = ".form" Тогда
...
//
Процедура СинхронизироватьХранилищеКонфигурацийСГит(Знач КаталогРабочейКопии, Знач ФайлХранилища, Знач НачальнаяВерсия = 0, Знач КонечнаяВерсия = 0, Знач Формат = "hierarchical") Экспорт
...
ОписаниеИерархическогоФормата = "hierarchical";
