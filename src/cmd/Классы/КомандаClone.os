...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	КлонироватьРепозиторий(КаталогРабочейКопии, URLРепозитория);
...
//
Процедура КлонироватьРепозиторий(Знач КаталогЛокальнойКопии, Знач URLРепозитория)

	Лог.Отладка("Каталог локальной копии: <%1>", КаталогЛокальнойКопии);
	Лог.Отладка("URL репозитория: <%1>", URLРепозитория);
	...
	ГитРепозиторий.КлонироватьРепозиторий(URLРепозитория, КаталогЛокальнойКопии);
