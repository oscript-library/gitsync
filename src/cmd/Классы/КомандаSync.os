...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("ti temp-ib", "", "строка соединения с временной информационной базой")
					.ТСтрока()
					.ВОкружении("GITSYNC_TEMP_IB")
					.ПоУмолчанию("");
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ВременнаяИБ             = Команда.ЗначениеОпции("temp-ib");
