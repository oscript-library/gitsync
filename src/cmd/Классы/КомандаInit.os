...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ПараметрыПриложения.ПроверитьЗагрузкуПлагинов();
	...
	ЭтоКаталогГит = ПроверитьНаличиеРепозиторияГит(КаталогРабочейКопии);
	Если Не ЭтоКаталогГит Тогда
		
		ИнициализироватьРепозиторий(КаталогРабочейКопии);
...
//
// Параметры:
//   КаталогЛокальнойКопии - Строка - каталог локальной копии
//
Процедура ИнициализироватьРепозиторий(Знач КаталогЛокальнойКопии) 
...
//   Булево - Истина, если каталог является каталогом или подкаталогом гит-репозитория
//
Функция ПроверитьНаличиеРепозиторияГит(Знач КаталогЛокальнойКопии) 
