...
Процедура ВыполнитьПриложение()
	...
	Приложение.Опция("e extension", Ложь, "работа с хранилищем расширения")
					.Флаговый()
...
Процедура ПередВыполнениемКоманды(Знач Команда) Экспорт
	...
	ЭтоРасширение = Команда.ЗначениеОпции("extension"); 
	...
	ПараметрыПриложения.УстановитьРаботуСРасширением(ЭтоРасширение);
