...
Процедура ВыполнитьПриложение()
	...
	Приложение.ДобавитьКоманду("set-version sv", "Устанавливает необходимую версию в файл VERSION", Новый КомандаSetVersion);
...
Процедура ПередВыполнениемКоманды(Знач Команда) Экспорт
	...
	Лог.информация("Устанавливаю общие параметры");
