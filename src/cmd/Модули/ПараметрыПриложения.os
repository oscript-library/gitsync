...
Процедура Инициализация()
	...
	ОбщиеПараметры.Вставить("ВерсияПлатформыВыгрузки", "");
	ОбщиеПараметры.Вставить("ПутьКПлатформеВыгрузки", "");
...
Процедура УстановитьВерсиюПлатформыВыгрузки(Знач ВерсияПлатформыВыгрузки) Экспорт
	ОбщиеПараметры.Вставить("ВерсияПлатформыВыгрузки", ВерсияПлатформыВыгрузки);
КонецПроцедуры
...
Процедура УстановитьПутьКПлатформеВыгрузки(Знач ПутьКПлатформеВыгрузки) Экспорт
	ОбщиеПараметры.Вставить("ПутьКПлатформеВыгрузки", ПутьКПлатформеВыгрузки);
КонецПроцедуры
