...
Процедура ЗаписатьВключенныеПлагины() Экспорт
	...
	Для каждого КлючЗначение Из МенеджерПлагинов.ИндексПлагинов Цикл
...
Процедура ВыполнитьПодпискуПриРегистрацииКомандыПриложения(Команда) Экспорт
	...
	ОбработчикПодписок = ПараметрыПриложения.МенеджерПлагинов().НовыйМенеджерПодписок();
...
Процедура УстановитьРежимОтладкиПриНеобходимости(Знач РежимОтладки) Экспорт
	...
	Если РежимОтладки Тогда
		...
		ПараметрыПриложения.МенеджерПлагинов().УстановитьРежимОтладки();
